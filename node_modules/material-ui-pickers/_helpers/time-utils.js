...
var getHours = exports.getHours = function getHours(offsetX, offsetY, ampm) {
...
var getMinutes = exports.getMinutes = function getMinutes(offsetX, offsetY) {
...
var convertToMeridiem = exports.convertToMeridiem = function convertToMeridiem(time, meridiem, ampm, utils) {
  if (ampm) {
